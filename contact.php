...
<div class="contact">
  <div class="container">
    ...
    <div class="row g-3">
      <div class="col-md-6">
        <!-- <img src="<?php echo $img ?>./ma_creations.jpg" width="100%" class="img-contact" alt="Messages"> -->
        <img src="./ma_creations.jpg" width="100%" style="height: 430px; border-radius: 15px;" class="img-contact" alt="Messages">
      </div>
      <div class="col-md-6">
