...
?>
  <div class="order-received">
    <div class="container">
      <h1>Thank you. Your order has been received.</h1></br>
      <h3>*Please note Your Order ID To track your order.</h3></br>
      <h3>*Further Details will be conveyed to your mobile number.</h3></br>
